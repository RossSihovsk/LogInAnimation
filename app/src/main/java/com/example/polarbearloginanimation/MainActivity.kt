package com.example.polarbearloginanimation
...
import com.example.polarbearloginanimation.databinding.ActivityMainBinding
        ...
        binding.button.setOnClickListener {
            ...
            Handler(mainLooper).postDelayed({
                if( binding.email.text!!.isNotEmpty()  && binding.password.text!!.isNotEmpty() &&
                    (binding.email.text.toString()=="rsihovskiy@gmail.com" && binding.password.text.toString()=="qwerty")){
